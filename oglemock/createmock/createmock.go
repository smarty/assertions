...
import (
	...
	_ "github.com/smartystreets/assertions/oglemock/generate"
)
...
func run() error {
	...
	buildPkg, err := build.Import("github.com/smartystreets/assertions/oglemock", "", build.FindOnly)
	if err != nil {
	...
	arg.Imports["generate"] = "github.com/smartystreets/assertions/oglemock/generate"
	arg.Imports["log"] = "log"
	arg.Imports["os"] = "os"
